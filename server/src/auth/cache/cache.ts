...
const VALKEY_URI = optionalEnvString('REDIS_URI_OBO_CACHE_KABIN');
const VALKEY_USERNAME = optionalEnvString('REDIS_USERNAME_OBO_CACHE_KABIN');
const VALKEY_PASSWORD = optionalEnvString('REDIS_PASSWORD_OBO_CACHE_KABIN');
