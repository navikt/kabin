import { EditLogiskVedlegg } from '@app/components/documents/journalpost/document/logiske-vedlegg/editable/logisk-vedlegg/edit';
import { ReadOnlyTag } from '@app/components/documents/journalpost/document/logiske-vedlegg/shared/vedlegg-style';
