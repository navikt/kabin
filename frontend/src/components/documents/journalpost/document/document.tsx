...
import { AttachmentList } from '@app/components/documents/journalpost/document/attachment-list';
import { AvsenderMottakerNotatforer } from '@app/components/documents/journalpost/document/avsender-mottaker-notatforer';
import { DocumentTitle } from '@app/components/documents/journalpost/document/document-title';
import { ExpandButton } from '@app/components/documents/journalpost/document/expand-button';
import { canOpen } from '@app/components/documents/journalpost/document/filetype';
import { SelectDocumentButton } from '@app/components/documents/journalpost/document/select-document-button';
import type { BaseSelectDocumentProps } from '@app/components/documents/journalpost/document/types';
import { useViewDocument } from '@app/components/documents/journalpost/document/use-view-document';
import { ViewDocumentButton } from '@app/components/documents/journalpost/document/view-document-button';
import {
  CustomTooltipField,
  GridArea,
  GridTag,
  SimpleTextField,
  StyledGrid,
} from '@app/components/documents/journalpost/styled-grid-components';
