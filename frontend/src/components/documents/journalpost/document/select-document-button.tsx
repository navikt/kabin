...
import type { CanBeSelected, SelectJournalpost } from '@app/components/documents/journalpost/document/types';
import { GridArea, GridButton } from '@app/components/documents/journalpost/styled-grid-components';
