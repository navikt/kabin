  ...
  return (
    <Card>
      ...
      <SelectedMulighetBody
        ...
        columns={COLUMNS}
        type={MulighetType.ANKE_AFTER_2027}
      />
    </Card>
  );
};
...
interface ContentProps {
  ankemuligheter: IAnkemulighetAfter2027[] | undefined;
  isLoading: boolean;
}
...
const Content = ({ ankemuligheter, isLoading }: ContentProps) => {
  if (isLoading) {
    return (
      <LoadingMuligheter label="Ankemuligheter" columns={COLUMNS} type={MulighetType.ANKE_AFTER_2027} selectable />
    );
  }
...
const COLUMNS: (keyof IAnkemulighetAfter2027)[] = [
  'typeId',
  'fagsakId',
  'temaId',
  'ytelseId',
